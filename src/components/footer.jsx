            ...
            <Container>
                <Row>
                    <Col xs={6} sm={6} md={3}>
                        ...
                        <p className="mt-2">&copy;2025 Automatons, <br />All rights reserved.</p>
                    </Col>
                            ...
                            <Col xs={6} sm={6} md={12}>
                                <p className="text-end w-md-100"> 
                                    <a className="automatonsai-icons mb-3" href="https://www.instagram.com/automatonsai/" target="_blank">
                                        <svg><use xlinkHref="/automatonsai/icons/automatonsai-icons.svg#instagram"></use></svg>
                                    </a>
                                    <a className="automatonsai-icons mb-3" href="https://twitter.com/automatonsai" target="_blank">
                                        <svg><use xlinkHref="/automatonsai/icons/automatonsai-icons.svg#X"></use></svg>
                                    </a>  
                                </p>
                            </Col>
                            <Col xs={6} sm={6} md={12}>
                                <p className="mt-lg-2 text-end w-md-100">
                                    <a className="automatonsai-icons mb-3" href="https://www.facebook.com/automatonsai" target="_blank">
                                        <svg><use xlinkHref="/automatonsai/icons/automatonsai-icons.svg#facebook"></use></svg>
                                    </a>
                                    <a className="automatonsai-icons mb-3" href="https://automatonsai.medium.com/" target="_blank">
                                        <svg><use xlinkHref="/automatonsai/icons/automatonsai-icons.svg#medium"></use></svg>
                                    </a>       
                                </p>
                            </Col>
                        </Row>
